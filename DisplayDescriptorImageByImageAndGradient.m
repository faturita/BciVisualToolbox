function DisplayDescriptorImageByImageAndGradient(frames,descriptor,image,descriptorid,gradient)
...
DisplayDescriptorImageByImage(frames,descriptor,image,descriptorid);
hold on;

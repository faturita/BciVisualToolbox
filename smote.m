...
I = nearestneighbour(T, X, 'NumberOfNeighbours', nb); % sólo hay 2!!
...
I = nearestneighbour(original_features', original_features', 'NumberOfNeighbours',nb);
I = I';
%{
